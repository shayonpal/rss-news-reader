...
class TokenManager {
  constructor() {
    this.tokensPath = process.env.RSS_READER_TOKENS_PATH || path.join(process.env.HOME, '.rss-reader', 'tokens.json');
  ...
  async refreshTokens() {
    if (!this.tokens || !this.tokens.refresh_token) {
      throw new Error('No refresh token available. Please run OAuth setup again.');
    }
