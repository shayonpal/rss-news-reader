...
>(({ currentFilter }, ref) => {
  ...
  const generateMockArticles = (
    ...
    return Array.from({ length: count }, (_, index) => ({
      ...
      ai_summary:
        Math.random() > 0.8
          ? "AI-generated summary of the key points and insights from this article."
          : undefined,
  ...
  const fetchArticles = async (isRefresh: boolean = false) => {
    try {
      ...
      await new Promise((resolve) =>
        setTimeout(resolve, isRefresh ? 1500 : 1000)
      );
        ...
        prev.map((article) =>
          article.id === articleId
            ? {
                ...article,
                ai_summary:
                  "This AI-generated summary highlights the key insights and main points from the article, providing a concise overview of the most important information.",
                is_summarized: true,
              }
            : article
        )
