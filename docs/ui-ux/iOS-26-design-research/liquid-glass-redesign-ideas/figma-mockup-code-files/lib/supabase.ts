...
function generateMockFeeds(): Feed[] {
  return [
    ...
    // Science & Research folder
    {
      id: 8,
      title: "Nature",
      url: "https://nature.com/nature.rss",
      folder_id: 3,
      unread_count: 3,
    },
    {
      id: 9,
      title: "Science Daily",
      url: "https://sciencedaily.com/rss/all.xml",
      folder_id: 3,
      unread_count: 9,
    },
    {
    ...
    },
    {
      ...
      url: "https://fastcompany.com/design/rss",
      folder_id: 4,
    }, // No unread count
    ...
    },
    {
      id: 17,
      title: "Forbes Tech",
      url: "https://forbes.com/technology/feed/",
      folder_id: 5,
      unread_count: 9,
    },
  ];
  ...
  return Array.from({ length: count }, (_, index) => {
    ...
    return {
      ...
      title:
        ...
        (index >= titles.length
          ? ` (Part ${Math.floor(index / titles.length) + 1})`
          : ""),
      ...
      ai_summary: isSummarized
        ? "AI-generated summary: This article provides comprehensive insights into recent developments and their broader implications for the industry."
        : undefined,
      ...
      const queryBuilder = {
        order: (column: string, options?: any) => {
          ...
          result.limit = (count: number) => ({
            data:
              table === "articles" ? generateMockArticles(count) : result.data,
            error: null,
          });
        ...
        eq: (column: string, value: any) => ({
          data: (() => {
            if (table === "feeds" && column === "folder_id") {
              return generateMockFeeds().filter(
                (feed) => feed.folder_id === value
              );
            }
