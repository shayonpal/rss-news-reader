      ...
      <ToastProvider>
        ...
        >
          ...
          <div className="pointer-events-none fixed inset-0">
            ...
            <div className="absolute inset-0 animate-pulse bg-gradient-to-r from-blue-500/5 via-transparent to-purple-500/5" />
            <div className="absolute left-0 top-0 h-1/3 w-full bg-gradient-to-b from-white/20 to-transparent dark:from-slate-700/10 dark:to-transparent" />
          ...
          <div className="relative z-10">
            ...
            <Header
              ...
              currentFilter={
                activeTab === "articles" ? articleFilter : undefined
              }
