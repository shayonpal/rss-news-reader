    ...
    >
      ...
      {unreadCount > 0 && (
        <span
          className={
            isSelected
              ? "ml-2 inline-flex shrink-0 items-center justify-center rounded-full bg-[var(--counter-selected-bg)] px-2 py-0.5 text-xs font-medium text-[var(--counter-selected-text)]"
              : "ml-2 inline-flex shrink-0 items-center justify-center rounded-full bg-[var(--counter-unselected-bg)] px-2 py-0.5 text-xs font-medium text-[var(--counter-unselected-text)]"
          }
        >
