...
export function HealthStatusWidget() {
  const { currentHealth, performHealthCheck, unreadAlertCount } =
    useHealthStore();
            ...
            <div className="px-2 py-1.5">
              ...
              {unreadAlertCount > 0 && (
                <div className="mb-2 flex items-center gap-2 text-yellow-600 dark:text-yellow-400">
                  ...
                  <span className="text-sm">
                    {unreadAlertCount} active alert
                    {unreadAlertCount !== 1 ? "s" : ""}
                  </span>
                </div>
              )}
              ...
              <div className="space-y-1 text-xs text-muted-foreground">
                ...
                <div className="flex justify-between">
                  ...
                  <span>
                    {Math.round(currentHealth.metrics.avgResponseTime)}ms
                  </span>
                </div>
              </div>
            </div>
