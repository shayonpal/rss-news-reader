...
describe('RR-146: CollapsibleFilterSection Component Tests', () => {
  ...
  describe('Core Functionality', () => {
    ...
    it('should display item count when provided', () => {
      ...
      expect(screen.getByText('64')).toHaveClass('text-xs', 'text-muted-foreground');
    });
    ...
    it('should display unread count badge when provided', () => {
      ...
      expect(badge).toHaveClass('rounded-full', 'bg-primary/10', 'text-primary');
    });
  ...
  describe('Collapse/Expand Behavior', () => {
    ...
    it('should complete animation within 200ms', async () => {
      ...
      const chevron = screen.queryByTestId('chevron-down-icon') || screen.queryByTestId('chevron-right-icon');
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle very long titles with truncation', () => {
      const longTitle = 'This is a very long title that should be truncated properly in the UI';
