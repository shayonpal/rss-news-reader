 ...
 */
export const ScrollableContentHeader = React.memo(function ScrollableContentHeader({
  selectedFeedId,
  selectedFolderId,
  selectedTagId,
}: ScrollableContentHeaderProps) {
  console.log('%c[ScrollableContentHeader] I AM MOUNTING', 'color: green; font-size: 16px;');
  ...
  return (
    <div
      ...
      className="fixed left-0 right-0 z-50 bg-background/95 backdrop-blur-sm border-b transition-all duration-300 ease-out"
      style={{
