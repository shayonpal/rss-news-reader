...
export class SyncConflictDetector {
   ...
   */
  private getConflictType(local: any, remote: any): 'read_status' | 'starred_status' | 'both' {
  ...
  public generateReport(): string {
    ...
    if (this.summary.totalConflicts > 10) {
      report.push('');
      report.push('⚠️ High conflict rate detected. Consider more frequent syncs.');
    }
