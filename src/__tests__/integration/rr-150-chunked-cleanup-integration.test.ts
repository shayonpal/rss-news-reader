...
describe("RR-150: Chunked Cleanup Integration", () => {
  ...
  describe("Chunked Article Cleanup API Integration", () => {
    it("should handle large article cleanup without 414 URI Too Large errors", async () => {
      ...
      const response = await fetch(
        `http://localhost:${testPort}/reader/api/sync`,
        {
          method: "POST",
          headers: {
      ...
      if (result.cleanup) {
        ...
        const has414Error = result.cleanup.errors?.some(
          (error: string) =>
    ...
    it("should process cleanup in chunks when many articles exist", async () => {
      ...
      const response = await fetch(
        `http://localhost:${testPort}/reader/api/cleanup/read-articles`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      const uriErrors = result.errors.filter(
        (error: string) =>
          error.includes("414") ||
          error.includes("URI") ||
    ...
    it("should maintain data consistency during chunked operations", async () => {
      ...
      const response = await fetch(
        `http://localhost:${testPort}/reader/api/cleanup/test-consistency`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      expect(result.articlesDeleted).toBeLessThanOrEqual(
        result.trackingEntriesCreated
      );
    ...
    it("should handle partial failures gracefully in chunked processing", async () => {
      ...
      const response = await fetch(
        `http://localhost:${testPort}/reader/api/cleanup/test-partial-failure`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  describe("Performance and Resource Management", () => {
    it("should complete large cleanup operations within reasonable time", async () => {
      ...
      const response = await fetch(
        `http://localhost:${testPort}/reader/api/cleanup/performance-test`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
    ...
    it("should maintain stable memory usage during large operations", async () => {
      const response = await fetch(
        `http://localhost:${testPort}/reader/api/cleanup/memory-test`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      const memoryGrowth =
        result.memoryStats.peakMemory - result.memoryStats.initialMemory;
  ...
  describe("Error Recovery and Resilience", () => {
    it("should recover from database connection issues between chunks", async () => {
      const response = await fetch(
        `http://localhost:${testPort}/reader/api/cleanup/test-resilience`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
    ...
    it("should handle Cloudflare/proxy errors that triggered RR-150", async () => {
      const response = await fetch(
        `http://localhost:${testPort}/reader/api/cleanup/test-proxy-errors`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      const has414Error = result.errors.some(
        (error: string) =>
          error.includes("414") || error.includes("Request-URI Too Large")
      );
      expect(has414Error).toBe(false);
  ...
  describe("Configuration and Flexibility", () => {
    it("should respect custom chunk sizes from system configuration", async () => {
      const response = await fetch(
        `http://localhost:${testPort}/reader/api/cleanup/test-config`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
    ...
    it("should allow configurable delays between chunks", async () => {
      const response = await fetch(
        `http://localhost:${testPort}/reader/api/cleanup/test-delays`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  describe("Monitoring and Observability", () => {
    it("should provide detailed metrics for chunked operations", async () => {
      const response = await fetch(
        `http://localhost:${testPort}/reader/api/cleanup/test-metrics`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
    ...
    it("should log chunk processing progress for monitoring", async () => {
      const response = await fetch(
        `http://localhost:${testPort}/reader/api/cleanup/test-logging`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
