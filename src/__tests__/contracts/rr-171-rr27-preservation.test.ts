  ...
  describe('RR-27 State Consistency', () => {
    it('should maintain consistent state across all operations', () => {
      ...
      expect(states).toEqual([
        { hasTimer: false, articleId: null, isPaused: false, remainingTime: 2000 },
        { hasTimer: true, articleId: 'article-1', isPaused: false, remainingTime: 2000 },
        { hasTimer: false, articleId: 'article-1', isPaused: true, remainingTime: 1000 },
        { hasTimer: true, articleId: 'article-1', isPaused: false, remainingTime: 1000 },
        { hasTimer: false, articleId: null, isPaused: false, remainingTime: 2000 }
      ]);
    });
