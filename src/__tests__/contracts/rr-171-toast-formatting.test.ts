...
describe("RR-171: Toast Formatting Contract", () => {
  ...
  beforeEach(() => {
    ...
    toastManager = {
      ...
      showRateLimitError: vi.fn((retryAfter) => {
        mockToast.error(
          `API rate limit reached. Try again in ${retryAfter} seconds`,
          {
            duration: 8000,
          }
        );
  ...
  describe("Message Formatting Rules", () => {
    ...
    it("should use bullet separators for multiple segments", () => {
      ...
      expect(message).toBe(
        "Sync complete • 10 new articles • 5 removed • 2 new topics"
      );
  ...
  describe("Special Cases", () => {
    ...
    it("should handle large numbers correctly", () => {
      ...
      expect(message).toBe(
        "Sync complete • 1234 new articles • 567 removed • 89 new topics"
      );
