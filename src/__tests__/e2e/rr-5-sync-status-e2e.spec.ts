...
async function mockApiUsageResponse(page: Page, zone1Usage: number, zone2Usage: number) {
...
test.describe('RR-5: Sync Status Display - E2E Tests', () => {
  ...
  test.describe('Sidebar API Usage Display', () => {
    test('should display API usage with zone percentages on page load', async ({ page }) => {
      ...
      await expect(sidebar.locator('text=/API Usage/i')).toBeVisible({ timeout: 10000 });
  ...
  test.describe('Sync Flow with Usage Updates', () => {
    test('should update API usage after manual sync', async ({ page }) => {
      ...
      const syncButton = page.locator('[data-testid="sync-button"], button:has-text("Sync")');
  ...
  test.describe('Real-time Updates', () => {
    test('should update display when usage changes without page reload', async ({ page }) => {
      // Initial usage
  ...
  test.describe('Mobile Responsiveness', () => {
    test('should display API usage correctly on mobile viewport', async ({ page }) => {
      // Set mobile viewport
