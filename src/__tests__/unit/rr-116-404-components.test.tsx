...
describe('RR-116: 404 Page Components Unit Tests', () => {
  ...
  describe('Article 404 Page Component', () => {
    it('should render article-specific 404 content', () => {
      ...
      expect(screen.getByText("The article you're looking for doesn't exist or has been removed.")).toBeInTheDocument();
    });
    ...
    it('should display FileQuestion icon', () => {
      ...
      expect(icon).toHaveClass('mx-auto', 'mb-4', 'h-12', 'w-12', 'text-gray-400');
    });
    ...
    it('should use proper layout and styling classes', () => {
      ...
      expect(mainContainer).toHaveClass('flex', 'min-h-screen', 'items-center', 'justify-center', 'p-4');
    });
    ...
    it('should have proper dark mode styling', () => {
      ...
      const description = screen.getByText("The article you're looking for doesn't exist or has been removed.");
      expect(description).toHaveClass('mb-6', 'text-gray-600', 'dark:text-gray-400');
    });
  ...
  describe('Responsive Design', () => {
    it('should use responsive padding classes', () => {
      ...
      const container = screen.getByText('Article not found').closest('.flex.min-h-screen');
    ...
    it('should constrain width appropriately', () => {
      ...
      const contentContainer = screen.getByText('Article not found').closest('div');
