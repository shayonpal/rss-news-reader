  ...
  describe("Service health reporting for increased frequency", () => {
    it("should track recent runs for all 6 daily executions", async () => {
      const recentRuns = [
        ...
        {
          time: "2025-08-05T06:00:00.000Z",
          status: "success",
          duration: 48000,
        },
        {
          time: "2025-08-05T10:00:00.000Z",
          status: "success",
          duration: 43000,
        },
        {
          time: "2025-08-05T14:00:00.000Z",
          status: "success",
          duration: 46000,
        },
      ];
    ...
    it("should calculate appropriate success rate for 6x frequency", async () => {
      ...
      // Count successes
      const successCount = data.recentRuns.filter(
        (run: any) => run.status === "success"
      ).length;
