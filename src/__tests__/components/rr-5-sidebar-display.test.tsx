...
const ApiUsageDisplay = () => {
  ...
  return (
    <div data-testid="api-usage" className="space-y-1 text-xs">
...
describe("RR-5: Sidebar API Usage Display - Component Tests", () => {
  ...
  describe("Real-time Updates", () => {
    it("should update display when store values change", async () => {
      ...
      expect(screen.getByTestId("api-usage")).toHaveTextContent(
        "2.0% (zone 1)"
      );
      expect(screen.getByTestId("api-usage")).toHaveTextContent(
        "10.0% (zone 2)"
    ...
    it("should handle transition from loading to loaded state", async () => {
      ...
      await waitFor(() => {
        expect(screen.getByTestId("api-usage")).not.toHaveTextContent(
          "Loading..."
        );
        expect(screen.getByTestId("api-usage")).toHaveTextContent(
          "4.7% (zone 1)"
